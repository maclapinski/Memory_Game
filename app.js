...
document.querySelector('.btn-restart').addEventListener('click', function () {
  ...
  selectElement('dificultyLvlSelector', dificultyLvlSelected);
...
function dificultyLvlSet(){
  if(tilesCount == 24){
    dificultyLvl = dificultyLvlSelected;
  }
  if(tilesCount == 16){
    dificultyLvl = dificultyLvlSelected - 1;
  }
  if(tilesCount == 8){
    dificultyLvl = dificultyLvlSelected - 2;
  }
}
...
document.querySelector('#dificultyLvlSelector').addEventListener('change', (event) => {
  dificultyLvlSelected = event.target.value;
  dificultyLvlSet();
});
//*************************************************************************** */
//Single Player
let sPArray = [];
let dificultyLvlSelected = 4;
let dificultyLvl = 4;
